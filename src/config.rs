...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.560e.com"];
pub const RS_PUB_KEY: &str = "fNZJiCjOzsgXPfOS7PDl1cnaG15dOvAyAOtMkqdY15k";

pub const RENDEZVOUS_PORT: i32 = 56116;
pub const RELAY_PORT: i32 = 56117;
